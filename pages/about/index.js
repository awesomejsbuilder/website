      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        <div className="flex flex-1 flex-col justify-center">
          ...
          >
            ...
            collaborate on digital products for business and consumer use.
          </motion.p>
          {/* counter */}
          <motion.div
            ...
            animate="show"
            exit="hidden"
            className="hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 md:mb-8"
          >
        ...
        initial="hidden"
        animate="show"
        exit="hidden" className="flex flex-col w-full xl:max-w-[48%] h-[350px]">
            ...
            {aboutData[index].info.map((item, itemIndex) => {
              return (
                ...
                >
                  ...
                  <div className="hideen md:flex">-</div>
